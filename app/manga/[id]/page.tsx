...
export default function MangaDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-4 sm:py-8 lg:py-12">
        {/* Main Content */}
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 xl:gap-12">
          {/* Left Column - Cover Image */}
          <div className="w-full lg:w-80 xl:w-96 flex-shrink-0 flex justify-center lg:justify-start">
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-200 w-48 sm:w-64 lg:w-80 xl:w-96">
              <img 
